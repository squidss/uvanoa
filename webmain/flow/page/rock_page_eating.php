...
$(document).ready(function(){
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'报餐('+nowtabs.name+')',
				cont:'报餐('+nowtabs.name+')的列表的',
				explain:'订阅[报餐]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_eating|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelisteating = a;
			addtabs({num:'daorueating',url:'flow,input,daoru,modenum=eating',icons:'plus',name:'导入报餐'});
		},
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#vieweating_{rand}').bootstable(bootparams);
	c.init();
