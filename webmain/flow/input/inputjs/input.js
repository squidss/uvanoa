...
function initbodys(){}; // @squid 2018年3月30日10:16:56 js接口方法，用于初始化，需要在具体的mode_'自定义的模块'.js里面复写
function savesuccess(){}; // @squid 2018年3月30日10:16:56 js接口方法，用于保存成功后执行指定动作，需要在具体的mode_'自定义的模块'.js里面复写
