...
class agentModel extends Model
{
	...
	*/
	...
	/**
	 * @squid 2018年3月27日13:40:58
	 * @param unknown $uid 用户id 表admin主键
	 * @param unknown $num 模块对应的编号---在流程模块列表可以看
	 * @param unknown $lx 查询条件，用|分开
	 * @param unknown $page 查询页数
	 * @return number[]|array[]|unknown[]|mixed[]|string[]|NULL[]|boolean[]
	 */
	...
	*/
	public function getdatalimit($uid, $lx)
	{
		...
		foreach($rows as $k=>$rs){
			$jarr 	= array();
			$rs 	= $this->flow->flowrsreplace($rs, 2); // 模型类复写的方法
	...
	/**
	 * @squid 2018年3月27日14:37:50 格式化 “应用上摘要显示：” 在流程模块列表上面的具体模块上面编辑的
	 * @param unknown $str
